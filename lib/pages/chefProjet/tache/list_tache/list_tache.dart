  ...
  void updateData(List newData) {
    setState(() {
      ...
      if ((_dataFromFiltre![1] != null || _dataFromFiltre![2] != null) &&
          (_dataFromFiltre![1] != null && _dataFromFiltre![2] != null)) {
        if (_dataFromFiltre![1] == false) {
          displayList = displayList
              .where((item) => item.type == "rectification")
              .toList();
              ...
              Navigator.push(
                ...
                if (tacheCree != null) {
                  setState(() {
                    print('in set State');
                    displayList.add(
                        tacheCree); // Ajoute la nouvelle tâche à la liste des tâches
                    print('tachecree${taches}');
                  });
                }
              });
            },
